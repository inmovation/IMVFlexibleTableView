...
@interface IMVFlexibleTableView : UITableView
/**
...
@property (strong, nonatomic) IMVBaseTopRefreshView *topRefreshView;

@property (strong, nonatomic) IMVBaseLoadMoreView *loadMoreView;
