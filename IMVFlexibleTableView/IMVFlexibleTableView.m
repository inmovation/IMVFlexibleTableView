...
@interface IMVFlexibleTableView ()
...
- (IMVBaseTopRefreshView *)topRefreshView{
    if (!_topRefreshView) {
        _topRefreshView = [[IMVBaseTopRefreshView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, kPRRefreshViewHeight)];
    }
    return _topRefreshView;
}

- (IMVBaseLoadMoreView *)loadMoreView{
    if (!_loadMoreView) {
        _loadMoreView = [[IMVBaseLoadMoreView alloc] initWithFrame:CGRectMake(0, self.frame.size.height, self.frame.size.width, kPRLoadViewHeight)];
    }
...
- (void)customRefreshView{
    if (_topRefreshView) {
        _topRefreshView.frame = CGRectMake(0, 0, self.frame.size.width, kPRRefreshViewHeight);
    }
...
- (void)customLoadView{
    if (_loadMoreView) {
        _loadMoreView.frame = CGRectMake(0, self.frame.size.height, self.frame.size.width, kPRRefreshViewHeight);
    }
}
